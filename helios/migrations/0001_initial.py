    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "vote_tinyhash",
                    models.CharField(max_length=50, unique=True, null=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "datatype",
                    models.CharField(default=b"legacy/Election", max_length=250),
                ),
                ...
                (
                    "admin",
                    models.ForeignKey(to="helios_auth.User", on_delete=models.CASCADE),
                ),
            ],
            options={
                "abstract": False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "election",
                    models.ForeignKey(to="helios.Election", on_delete=models.CASCADE),
                ),
            ],
            options={},
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user",
                    models.ForeignKey(
                        to="helios_auth.User", null=True, on_delete=models.CASCADE
                    ),
                ),
            ],
            options={},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "voter_file",
                    models.FileField(
                        max_length=250, null=True, upload_to=b"voters/%Y/%m/%d"
                    ),
                ),
