...
MIDDLEWARE = [
    ...
    "helios_server.helios.security.HSTSMiddleware",
...
ROOT_URLCONF = "helios_server.urls"
...
INSTALLED_APPS = (
    ...
    ## HELIOS stuff
    "helios_server.helios_auth",
    "helios_server.helios",
    "helios_server.server_ui",
)
...
# election stuff
SITE_TITLE = get_from_env("SITE_TITLE", "Thalia Voting")
...
AUTH_ENABLED_SYSTEMS = get_from_env(
    "AUTH_ENABLED_SYSTEMS",
    get_from_env("AUTH_ENABLED_AUTH_SYSTEMS", "password,facebook,google,thalia"),
).split(",")
AUTH_DEFAULT_SYSTEM = get_from_env(
    "AUTH_DEFAULT_SYSTEM", get_from_env("AUTH_DEFAULT_AUTH_SYSTEM", None)
)
