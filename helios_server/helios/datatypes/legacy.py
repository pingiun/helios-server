...
from helios_server.helios.crypto import elgamal as crypto_elgamal
from helios_server.helios.workflows import homomorphic
from helios_server.helios import models
    ...
    def toDict(self, complete=False):
        ...
        if self.wrapped_obj.alias_num is not None:
            return super(Voter, self).toDict(
                self.ALIASED_VOTER_FIELDS, complete=complete
            )
        else:
