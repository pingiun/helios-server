...
from helios_server.helios.models import Trustee
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        active_helios_trustees = (
            Trustee.objects.exclude(secret_key=None)
            .exclude(election__encrypted_tally=None)
            .filter(decryption_factors=None)
        )
